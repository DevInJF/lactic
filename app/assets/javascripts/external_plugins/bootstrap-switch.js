    ...
    BootstrapSwitch = (function() {
      ...
      BootstrapSwitch.prototype._width = function() {
        ...
        $handles.add(this.$label).css("width", "");
          console.log("WIDTH HANDLE AUTO ??? "+(this.options.handleWidth === "auto"));
          console.log("WIDTH HANDLE MAX OF ON OFF ===  "+this.$on.width(), this.$off.width());
          console.log("WIDTH HANDLED "+this.options.handleWidth);
        ...
        this.$label.width((function(_this) {
          return function(index, width) {
            if (_this.options.labelWidth !== "auto") {
                //console.log("WIDTH this.options.labelWidth !== auto "+_this.options.labelWidth);

                return _this.options.labelWidth;
            }
            if (width < handleWidth) {
                //console.log("WIDTH width < handleWidth "+handleWidth);
        ...
        this.$container.width((this._handleWidth * 2) + this._labelWidth);
          //console.log("WIDTH else..... "+this.$wrapper.width(this._handleWidth + this._labelWidth));
