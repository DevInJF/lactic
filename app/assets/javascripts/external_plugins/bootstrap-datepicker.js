...
(function($, undefined){
	...
	var Datepicker = function(element, options){
		...
		this.component = this.element.is('.datepicker') ? this.element.find('.add-on, .input-group-addon, .btn') : false;
	...
	Datepicker.prototype = {
				...
				[$(document), {
					'mousedown touchstart': $.proxy(function(e){
						...
						if (!(
                            ...
                            //alert("Clicked outside the datepicker, hide it ");
							this.hide();
						}
					}, this)
				}]
		...
		remove: function(){
			...
			this._detachSecondaryEvents();
			this.picker.remove();
			delete this.element.data().bdatepicker;
			if (!this.isInput){
		...
		update: function(){
			...
			if (arguments.length){
				...
				dates = this.isInput
						? this.element.val()
						: this.element.data('bdatepicker') || this.element.find('input').val();
		...
		_setDate: function(date, which){
			...
			if (this.o.autoclose && (!which || which === 'bdatepicker')){
                //alert("HIDE _setDate");
				this.hide();
			}
		},
	...
	DateRangePicker.prototype = {
		...
		dateUpdated: function(e){
			...
			var dp = $(e.target).data('bdatepicker'),
	...
	$.fn.bdatepicker = function(option){
		...
		this.each(function(){
			var $this = $(this),
				data = $this.data('bdatepicker'),
				options = typeof option === 'object' && option;
            //alert("$.fn.bdatepicker ");
			if (!data){
				var elopts = opts_from_el(this, 'bdatepicker'),
					// Preliminary otions
				...
				if ($this.is('.input-daterange') || opts.inputs){
					...
					$this.data('bdatepicker', (data = new DateRangePicker(this, $.extend(opts, ropts))));
				}
				else {
					$this.data('bdatepicker', (data = new Datepicker(this, opts)));
				}
			}
...
(function($, Modernizr, window) {
    ...
    $.fn.bdatepicker.defaults.format = "mm/dd/yy";
        ...
        $inputs.each(function() {
            ...
            if (isMobile && Modernizr.inputtypes.date) {
                ...
                if (isMobile) {
                    ...
                    if (isMoment)
                        $input.bdatepicker('update', valMoment.toDate());
                    else
                        $input.bdatepicker();
                    if ($input.is(':focus'))
                        $input.bdatepicker('show');
                }
            }
